  ...
  return (
    <section className='flexCenter w-full flex-col pb-[100px]'>
      <div className='get-app'>
        ...
        <div className='z-20 flex flex-1 flex-col w-full items-start justify-center gap-8'>
          <h2 className='bold-40 lg:bold-64 xl:w-full'>Get it for free now!</h2>
          <p className='regular-16 text-slate-200'>Available on iOS and Android</p>
